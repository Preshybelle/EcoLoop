...
const IconSpark = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3l1.5 6.5L20 11l-6.5 1.5L12 19l-1.5-6.5L4 11l6.5-1.5L12 3z"/></svg>
);
const IconArrowLeft = () => (
        ...
        <main className="create-listing-content material-details-content">
          ...
          <div className="create-listing-card material-details-card">
            <div className="material-details-field">
              ...
              <div className="material-details-select-wrap">
                <select className="material-details-select" aria-label="Material type">
                  <option>Polyethylene (PE)</option>
                </select>
                <IconChevronDown />
              </div>
            </div>
            <div className="material-details-pills">
              <span className="material-details-pill material-details-pill-ai">
                <IconSpark /> AI Suggestion: High Density
              </span>
              <span className="material-details-pill material-details-pill-manual">Manual Override</span>
            </div>
            <div className="material-details-field">
